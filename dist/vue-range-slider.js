  ...
  methods: {
    ...
    bindEvents: function bindEvents() {
      ...
      this.changeDot = (e) => {
        this.size = this.direction === 'vertical' ? this.$refs.elem.offsetHeight : this.$refs.elem.offsetWidth;
        this.offset = this.direction === 'vertical' ? this.$refs.elem.getBoundingClientRect().top + window.pageYOffset || document.documentElement.scrollTop : this.$refs.elem.getBoundingClientRect().left;
        var pos = this.reverse ? this.size - (e.changedTouches[0].pageX - this.offset) : e.changedTouches[0].pageX - this.offset;
        ...
        me._start(e, this.currentSlider)
      }

      this.changeDotDesk = (e) => {
        this.size = this.direction === 'vertical' ? this.$refs.elem.offsetHeight : this.$refs.elem.offsetWidth;
        this.offset = this.direction === 'vertical' ? this.$refs.elem.getBoundingClientRect().top + window.pageYOffset || document.documentElement.scrollTop : this.$refs.elem.getBoundingClientRect().left;
        var pos = this.reverse ? this.size - (e.pageX - this.offset) : e.pageX - this.offset;
      ...
      if (isMobile) {
        addEvent(this.$refs.wrap, EVENT_TOUCH_START, this.changeDot)
        ...
        addEvent(this.$refs.wrap, EVENT_MOUSE_DOWN, this.changeDotDesk)
